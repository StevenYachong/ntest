...
const SUB_PATH = process.env.SUB_PATH || 'fang';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '31409de0-34c8-4aff-9a55-bc434a24e6e0'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'ntest';                        // 节点名称
